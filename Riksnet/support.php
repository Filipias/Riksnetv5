		...
		<div id="page-wrapper">
			<?php include("./includes/header.php"); ?>
						...
						<form method="POST" action="./run/skicka.php">
							<div class="formular">
								...
								<div class="form-group">
									...
									<input name="firstname" type="text" class="form-control" id="formGroupExampleInput" placeholder="102200">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<input name="phone" type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="07x-XXXXXXX">
								</div>
								<div class="form-group">
				...
				<footer id="footer">
					...
					<ul class="copyright">
						<b>Riksnet AB | Telefon: 0770-33 99 33 | Epost: support@riksnet.se | Adress: Formvägen 5, 90222 Umeå</b>
					</ul>
				</footer>
		</div>
	</body>
